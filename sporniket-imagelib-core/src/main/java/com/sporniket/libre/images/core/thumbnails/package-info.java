/**
 * All the building blocks to generate and manage image thumbnails.
 * 
 * <p>Thumbnails are generated in a working directory, and organised to avoid a big number of files to being located in the same directory.
 * <p>
